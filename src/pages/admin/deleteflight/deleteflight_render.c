...
int         admin_delete_flight_render(PartialContext *);
void        admin_delete_flight_render_clean(PartialContext *);
void        admin_delete_flight_error(mustache_api_t *, void *, uintmax_t, char const *);
